...
public class SettingsHandler {
	...
	public SettingsHandler() {
		...
		languageData2.answerDataPath = "../data/german_language_data/german_answer_data_file.txt";
		languageData2.cardDataPath = "../data/german_language_data/german_words.txt";
		languageData2.grammarDataPath = "../data/german_language_data/german_grammar_data.txt";
		languageData2.grammarAnswerDataPath = "../data/german_language_data/german_grammar_answer_data_file.txt";
