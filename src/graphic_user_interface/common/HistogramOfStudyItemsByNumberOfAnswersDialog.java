...
public class HistogramOfStudyItemsByNumberOfAnswersDialog extends javax.swing.JDialog {

    public AnswerDataContainer answerDataContainer;

    public HistogramOfStudyItemsByNumberOfAnswersDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "number of answers", "number of study items"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistogramOfStudyItemsByNumberOfAnswersDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HistogramOfStudyItemsByNumberOfAnswersDialog dialog = new HistogramOfStudyItemsByNumberOfAnswersDialog(new javax.swing.JFrame(), true);
