...
public class GrammarItemSelecterDialog extends javax.swing.JDialog {
    
    private Set<Integer> outGrammarItemIndexes;
    ...
    public GrammarItemSelecterDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setSelectedCategories(Set<Integer> categoryIndexes) {
        ...
        outGrammarItemIndexes = categoryIndexes;
    }
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        outGrammarItemIndexes.clear();
        
        for (int i=0; i<selectedCategoryContainer.numberOfItems(); i++) {
            outGrammarItemIndexes.add(selectedCategoryContainer.getCategoryByOrder(i).index);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GrammarItemSelecterDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GrammarItemSelecterDialog dialog = new GrammarItemSelecterDialog(new javax.swing.JFrame(), true);
