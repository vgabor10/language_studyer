...
12 | Du machst Ordnung in deinem Zimmer, sonst gehst du in Schwimmbad nicht. | Rendet csinálsz a szobádban, különben nem mész uszodába. (s Schwimmbad)
...
10 | Hattet ihr Bauchweh? | Fájt a hasatok? (haben Bauchweh)
...
4 | Er wird von ihnen auf seinen Geburtstag gratuliert werden. | Gratulálni fognak neki (f) ők a születésnapjára.
5 | Deine Briefe werden von ihnen nicht geantwortet werden. | A leveleidre nem fognak (ők) válaszolni.
...
9 | Interessant Vorstellung wird in dem Theater gespielt werden. | Érdekes előadást fognak játszani a színházban. (e Vorstellung)
