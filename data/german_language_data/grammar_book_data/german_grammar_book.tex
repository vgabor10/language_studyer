...
3 | Sie tut ihre Tochter hierher. | A lányát ide teszi (n).
...
14 | Der Kellner empfiehlt sie den Gästen . | A pincér őt (n) ajánlja a vendégeknek.
\end{exmp}
...
\begin{desc}
Képzése:
alany + hätte/wäre ragozve + többi mondatrész + ige befelyezett alakja
...
%Maklári: 282. oldal
\begin{exmp}
1 | Er hätte geholfen. | Segített volna.
...
12 | Sie hätten ein Buch geschreiben. | Írtak volna egy könyvet.
...
19 | Ich hätte auf dem Zug Karten gespielt. | Kártyáztam volna a vonaton.
...
7 | Wie wären die Vorstellung gewesen? | Milyen lett volna az előadás? (e Vorstellung - előadás)
8 | Wäret ihr in dem Auto gewesen? | Az autóban lettek volna?
...
6 | Er hättet Mut dazu gehabt. | Lett volna bátorsága (f) a hozzá. (Mut haben dazu - van bátorsága hozzá)
...
12 | Sie hätte zwei Kindern gehabt. | Két gyermeke lett volna.
13 | Hättest du Geduld gehabt? | Lett volna türelmed?
14 | Ihr hättet Recht gehabt. | Igazatok lett volna. (Recht gehabt - igaza van)
15 | Sie hättet Sorgen gehabt. | Gondjai (n) lettek volna. (Sorgen haben - gondjai vannak)
\end{exmp}
...
alany + hätte ragozva + többi mondatrész + ige Infinitiv - ben + módbeli segédige Infinitiv - ben
...
6 | Ich hätte sie willkommen müssen. | Üdvözölnöm kellet volna őt (n).
...
12 | Ihr hättet die Kinder bringen können. | El tudtátok volna hozni a gyerekeket.
...
15 | Du hättest ihr ihre Name fragen können. | Megkérdezhetted volna tőle (n) a nevét.
16 | Der Verkäufer hätte den Schuh umtauschen können. | Az eladó kicserélhette volna a cipőt. (umtauschen - kicserél)
17 | Du hättest von dem Heim nicht weggehen dürfen. | Nem szabadott volna elmenned otthonról. (s Heim - otthon, weggehen - elmegy)
\end{exmp}
...
8 | Das Gebäude wird durch eine Firma gebaut. | Az épületet egy cég építi.
...
12 | Geschänk muss der Oma gekauft werden. | A nagyinak ajándékot kell venni.
...
10 | Die Großmutter nimmt ihre Börse mit, um Karottel zu kaufen. | A nagymama magával viszi az pénztárcáját, hogy krumplit vásárolhasson. (mitnehmen - magával visz)
...
12 | Ich helfe jetzt ihr, damit sie später mir hilft. | Most én segítek neki (n), hogy később ő segítsen nekem.
...
42 | viele dicke Freu | sok kövér nő
43 | einige mange Männer | néhány kövér férfi 
44 | lautem, kleinem, nervösem Hund | hangos, kicsi, ideges kutyának
45 | lbillige, gute Ware | olcsó, jó áruk
