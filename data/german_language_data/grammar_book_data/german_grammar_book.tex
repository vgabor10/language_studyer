...
27 | die Kleider jenes Menschens | azoknak az embereknek a ruhái (r Mensch)
...
32 | die Rade jenes Wagens | annak a kocsinak a kerekei
...
20 | wovor | mi előtt
21 | worin | mibe
22 | worunter | mi mögött
23 | wogegen | mi ellen
24 | worauf | mire (vízszintes)
\end{exmp}

\subsubsection{Ellettelenre vonatkozó kérdésre való válaszok}
...
11 | Er steht hier nicht mehr. | Már nem áll itt.
...
34 | Die Gäste essen nichts mehr. | A vendégek már nem sznek.
\end{exmp}
...
16 | Er hätte Zeit nicht. | Nem lenne ideje (f).
...
3 | Sie räumt das Zimmer auf, um in das Gäscheft nicht gehen zu müssen. | Kitakarítja (n) a szobát, hogy ne kelljen boltba mennie. (aufräumen)
...
6 | Ich habe die Tür eingeschlossen, damit das Hund nicht ausgehen kann. | Becsuktam az ajtót, hogy ne tudjon kimenni a kutya. (einschließen)
...
8 | Wir machte hocher Zaun, damit die Nachbarn nicht überklettern zu können. | Magas keítést csináltunk, hogy ne tudjanak átmászni szomszédok. (überklettern)
...
25 | diese gelbe Jacke | ezt a sárga dzsekit (e Jacke - dzseki)
