...
A főnév, amire a jeder/e/es vonatkozik egyesszámban áll.
...
Haa jeder/e/es idővel kapcsolatos főnévre vonatkozik, akkor a főnevet  tárgyesetbe kell tenni.

Pl.: Jeden Tag besuchte ich ihn. - Minden nap meglátogatom őt.

Önállóan is használható: jeder = mindenki.

Pl.: Jeder weiß die Wahrheit. - Mindenki tudja az igazságot.
\end{desc}

%Maklári: 179. oldal
\begin{exmp}
1 | Wir geben jede Frau Blume. | Minden nőnek adunk virágot.
2 | Jeder Wagen gefällt ihm. | Minden autó tetszik neki (f).
3 | Wir geben jedem Gast Tee. | Minden vendégnek adunk teát.
4 | Jeder Schüler ist in Schule. | Minden tanuló az iskolában van.
5 | Sie hilft jedes Kind. | Minden gyereknek segít (n).
6 | Ich decke jeden Tisch. | Minden asztalt megterítek.
7 | Er hat in jedes Land eine Frau. | Minden országban van (f) egy felesége.
8 | Es gibt in jede Wohnung ein Badzimmer. | Minden lakásban van egy fürdőszoba. (es gibt)
9 | Jedes Buch kostet fünf Euro. | Minden könyv öt euróba kerül. (kostet + A, r Euro)
10 | Vater repariert heute jeder Tisch. | Apa holnap minden aszalt megjavít.
11 | Er spricht jeder Schüler in der Schule. | Minden tanulóval beszél (f) az iskolában.
12 | Sie streichelt jeder Hund. | Minden kutyát megsimogat (n). (streicheln)
13 | Er kommt jede Woche. | Minden héten jön (f).
14 | Er kauft jede Jahr ein Auto. | Minden évben vesz egy autót.
15 | Sie klingelt jede Uhr. | Minden órában csönget (n). (klingeln)
16 | Er bekommt jeden Monat ein Buch. | Minden hónapban kap (f) egy könyvet.
17 | Sie kauft mir jeden Anlass Süßigkeit. | Minden alkalommal vesz (n) nekem édességet. (r Anlass)
18 | Zwei Kunden kommen jede Minute. | Minden percben jön két vevő. (r Kunde)
19 | Jeder weiß das. | Mindenki tudja azt.
20 | Jeder ist von uns dort. | Mindenki ott van. (von + D)
21 | Jeder ist in ihner Familie krank. | A családjukban mindenki beteg.
22 | Er gebt für jener eine Blume. | Mindenkinek ad egy virágot.
23 | Er spricht mit jeder aus der Gruppe. | Mindenkivel beszél a csoportból.
24 | Sie kennt jeder aus der Klasse. | mindenkit ismer (n) az osztályból.
\end{exmp}
...
1) Az alle után a főnév mindig többesszámban van. A határozott névelő többesszámú végződéseit veheti fel:
N -> alle;
A -> alle;
D -> allen;
A -> aller.
...
2) Állhat önállóan is.

Pl.: Alle wollen mit mir kommen. - Mindenki velem akar jönni.
\end{desc}
...
7 | Er gebt allen Kollegen etwas. | Minden kollégának ad (f) valamit.
...
12 | Meine Freundin ruft mir alle fünf Minuten an. | A barátnőm minden öt percben felhív engem.
13 | Der Bus fährt alle zehn Minuten. | A busz 10 percenként jár. (fahren)
14 | Wir besuchen sie alle drei Jahre. | Háromévenként meglátogatjuk őket.
15 | Alle sind jetzt zu Hause. | Most mindenki otthon van.
16 | Alle sehen fern. | Mindenki TV-t néz.
17 | Alle sind müde Nachmittag. | Mindenki fáradt ebéd után.
18 | Ági denkt für alle. | Mindenkire gondol Ági. (für)
19 | Er gebt für alle etwas. | Mindenkinek ad (f) valamit. (für)
20 | Alle bekommen in diesem Land eine Wohnung. | Ebben az országban mindenki kap egy lakást.
21 | Alle sind krank in der Klasse. | Mindenki beteg az osztályban.
22 | Sie sagt von allen morgen etwas. | Mindenkiről mond (n) holnap valamit.
23 | Sie möchte mit allen sprechen. | Mindenkivel szeretne (n) beszélni.
24 | Sagst du mir es vor alle allen? | Mindenki előtt mondod ezt nekem?
\end{exmp}

\subsection{Alles, etwas ist alle}

GrammarItemIndex = 321953

\begin{desc}
1) alles = dolgok összessége

Pl.: * Alles ist in ordnung. - Minden rendben van.
* Alles klar. - Minden világos.

2) etwas ist alle = elfogyott, kifogyott
...
\begin{exmp}
1 | Kati kauft alles ein. | Mindent bevásárol Kati?
2 | Alles kosten viel. | Minden sokba kerül.
3 | Péter erledigt alles. | Péter mindent elintéz.
...
7 | Wir sind fertig mit alles. | Mindennel készen vagyunk.
...
11 | Verkaust du alles? | Mindent eladsz?
12 | Alles ist interessant. | Minden érdekes.
13 | Es gibt in dem Wagen alles. | A kocsiban van már minden.
14 | Er sucht etwas schlecht in alles. | Mindenben keres (f) valami rosszat.
...
18 | Er sagte alles derzeit. | Mindent mondott (f) akkor.
19 | Dieser Mensch ist fähig zu alles. | Ez az ember mindenre képes. (r Mensch, fähig sein zu + D)
20 | Alles ist hier. | Minden van itt.
21 | Die Zeitungen sind alle. | Elfogytak az újságok.
22 | Die Karten sind alle. | Elfogytak a jegyek. (e Karte)
23 | Das Benzin ist alle. | Elfogyott a benzin. (s Benzin)
24 | Die Kartoffel ist alle. | Elfogyott a krumpli. (e Kartoffel)
25 | Die Fahrräder sind alle. | Elfogytak a kerékpárok.
26 | Das Fleisch ist alle. | Elfogyott a hús.
27 | Die Bilder sind alle. | Elfogytak a képek.
28 | Das Brot ist alle. | Elfogyott a kenyér.
29 | Das Mineralwasser ist alle. | Elfogyott az ásványvíz.
\end{exmp}
