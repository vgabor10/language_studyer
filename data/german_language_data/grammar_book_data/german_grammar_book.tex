...
13 | Ich gebe alles ihm, weil er mein Freund ist. | Mindent neki (f) adok, mert a barátom.
14 | Weißt du, wer seine Eltern sind? | Tudod kik a szülei? !!!
15 | Wir weißen nicht, wann der Chef kommt. | Nem tudjuk, mikor jön a főnök.
16 | Er ist nicht sicher, ob er noch lebt. | Nem biztos abban (f), hogy él-e még.
...
6 | Wissen Sie der Name des Hotels? | Tudja (Ön) a hotel nevét?
...
18 | Er hätte recht. | Igaza lenne (f).
19 | Wir hätten Sorgen. | Gondjaink lennének.
20 | Ich hätte Hausaufgabe nicht. | Nem lenne házifeladatom.
...
4 | Was wäre dann geschehen? | Mi történt volna akkor? (geschehen - történik, dann - akkor)
...
17 | Er wäre rechtzeitig aufgestanden. | Időben felkelt (f) volna. (rechtzeitig - időben)
18 | Ich hätte die Hausaufgabe geschrieben. | Megírtam volna a házit.
19 | Ich hätte Karten auf dem Zug gespielt. | Kártyáztam volna a vonaton. (Karten spielen - kártyázik)
...
2 | Hättet ihr Zeit gehabt? | Lett volna időtök.
...
6 | Er hätte Mut dazu gehabt. | Lett volna bátorsága (f) a hozzá. (Mut haben dazu - van bátorsága hozzá)
7 | Sie hätten Fahrrad gehabt. | Lett volna kerékpárjuk.
8 | Ich hätte weniges Zeit dazu gehabt. | Kevés időm lett volna hozzá. (dazu - hozzá)
...
14 | Ihr hättet Recht gehabt. | Igazatok lett volna. (Recht haben - igaza van)
15 | Sie hätte Sorgen gehabt. | Gondjai (n) lettek volna. (Sorgen haben - gondjai vannak)
\end{exmp}
...
5 | Wir hätten in den Park ausgehen können. | Kimehettünk volna a parkba. (ausgehen - kimegy)
6 | Ich hätte sie willkommen müssen. | Üdvözölnöm kellet volna őt (n). (willkommen - üdvözöl)
...
10 | Wir hätten in das Kino gehen können. | Tegnap elmehettünk volna moziba.
11 | Du hättet ihr Blume nicht kaufen müssen. | Nem kellet volna neki (n) virágot venned.
12 | Ihr hättet die Kinder bringen können. | El tudtátok volna hozni a gyerekeket. (bringen - hoz)
...
16 | Der Verkäufer hätte den Schuh umtauschen können. | Az eladó kicserélhette volna a cipőt. (umtauschen - kicserél)
17 | Du hättest von Heim nicht weggehen dürfen. | Nem szabadott volna elmenned otthonról. (s Heim - otthon, weggehen - elmegy)
\end{exmp}
...
Pl.: Das Auto must von dem Mechanicer repariert werden. - A szerelőnek meg kell javítani az autót.
\end{desc}
...
6 | Die Bücher müssen ausgeliehen werden. | A könyveket ki kell kölcsönözni. (ausleihen - kikölcsönöz)
7 | Die Alte sollen geholfen werden. | Az öregeket segíteni kell. (e Alte - öregek)
...
13 | Der Kuchen darf von den Kindern nicht gegessen werden. | A gyerekek nem ehetik meg a süteményt. (r Kuchen - sütemény)
...
16 | Diese Angelegenheit muss gelöst werden. | Ezt az ügyet meg kell oldani. (e Angelegenheit - ügy)
...
\begin{exmp}
1 | Ich reise nach Deutschland, um die Sprache zu üben. | Németországba utazom, hogy gyakoroljam a nyelvet. (üben - gyakorol)
2 | Ich ziehe einen Mantel an, um schön auf der Party zu sein. | Felveszek egy kabátot, azért, hogy szép legyek a partin. (anziehen - felvesz)
3 | Er schläft viel, um schnell zu heilen. | Sokat alszik (f), hogy gyorsan meggyógyuljon.
4 | Ich hebe mein Geld aus der Bank ab, um ein Auto zu kaufen. | Felveszem a pénzem a bankból, hogy vegyek egy autót. (abheben - felvesz)
5 | Ich stehe früh auf, um den Bus zu erreichen. | Korán kelek, hogy elérjem a buszt. (erreichen - elér)
6 | Wir laufen schnell, um die Strassenbahn zu erreichen. | Gyorsan futunk, hogy elérjük a villamost. (erreichen - elér)
7 | Ich reise nach Österreich, um mich zu erholen. | Ausztiába utazom, hogy kipihenjem magamat. (sich erholen - kipiheni magát)
8 | Sie kommt zu mir, um mir zu helfen. | Eljön (n) hozzám, hogy segítsen nekem.
9 | Ich haste, um den Zug zu erreichen. | Sietek, hogy elérjem a vonatot. (hasten - siet, erreichen - elér)
...
11 | Ich gebe dir eine Ohrfeige, um besser mich zu füllen. | Adok neked egy pofont, hogy jobban étezzem magamat. (sich füllen - valahogy érzi magát)
\end{exmp}
...
2 | Ich gebe ihr Essen, damit sie hungrig nicht ist. | Adok neki (n) ételt, hogy ne legyen éhes. (s Essen - étel)
3 | Ich ende die Arbeit, damit der Nachbar nicht aufsteht. | Befejezem a munkát, hogy a szomszéd fel ne ébredjen.
4 | Ich gebe dir eine Uhr, damit du dich nicht verspätest. | Adok neked egy órát, hogy ne késs el. (sich verspäten - elkésik)
5 | Ich spüle, damit Mutter sich freut. | Elmosogatok, hogy örüljön anya. (sich freuen - örül)
6 | Der Arzt operiert meine Katze, damit sie lange lebt. | Az orvos megoperálja a macskámat, hogy sokáig éljen. (lange - sokáig)
7 | Ich lege mein Geld in die Bank ein, damit meine Freundin nicht verjubelt. | Beteszem a pénzemet a bankba, nehogy a barátnőm elköltse. (einlegen - betesz, verjubeln - elkölt, elszór)
8 | Ich ziehe den Vorhang weg, damit es Wärme in dem Zimmer nicht ist. | Elhúzom a függönyt, nehogy meleg legyen a szóbában. (wegziehen - elhúz, e Wärme - melegség)
9 | Ich helfe dir, damit du froh bist. | Segítek neked, hogy boldog legyél. (froh - boldog)
10 | Ich lade schnell in deine Tasche ein, damit du dich nicht verspätest. | Bepakolok gyorsan a táskádba, nehogy elkéssél. (einladen - bepakol)
11 | Ich gebe dir meinen Kamm, damit du dich kämmst. | Odaadom a fésűmet neked, hogy fésülködj meg. (r fésű - Kamm, sich kämmen - fésülködik)
12 | Ich helfe jetzt ihr, damit sie später mir hilft. | Most én segítek neki (n), hogy később ő segítsen nekem. (später - később)
...
%Maklári: 323. oldal
\begin{exmp}
1 | Mein Bruder hilft mir, damit ich die Hausaufgabe schreiben kann. | A tesvérem segít nekem, hogy meg tudjam írni a házit.
2 | Er schläft viel, um morgen gut fahren zu können. | Sokat alszik (f), hogy holnap jól tudjon vezetni.
3 | Sie räumt das Zimmer auf, um in das Gäscheft nicht gehen zu kommen. | Kitakarítja a szobát, hogy ne kelljen boltba mennie. (aufräumen - kitakarít)
4 | Ich kaufte mit ihr alles ein, damit ihr nicht müsst. | Bevásároltanam vele (n) mindent, hogy ne nektek kelljen.
5 | Ich repariere seinen Wagen, damit er das Rennen gewinnen kann.  | Megjavítom a kocsiját (f), hogy meg tudja nyerni a versenyt. (s Rennen - verseny, gewinnen - megnyer)
6 | Ich habe die Tür eingeschlossen, um das Hund nicht ausgehen kann. | Becsuktam az ajtót, hogy ne tudjon kimenni a kutya. (einschließen - becsuk)
7 | Ich gehe eher mit Taxi auf den Flughafen, um das Flugzeug erreichen zu können.  | Inkább taxival megyek a repülőtérre, hogy el tudjam érni a repülőgépet. (eher - inkább)
8 | Wir machte hocher Zaun, damit die Nachbarn nicht überklettern können. | Magas keítést csináltunk, hogy ne tudjanak átmászni szomszédok. (überklettern - átmászik)
9 | Er setzt ganzer Tag auf der Toilette, um nicht arbeiten zu müssen. |  Inkabb egész nap a VC-n ül (f), hogy ne kelljen dolgoznia.
...
3 | gute Fahrt | jó utazást (e Fahrt - utazás)
4 | schönes Bild | szép kép
5 | dicke Frau | kövér nő (dick - kövér)
6 | magerer Hund | sovány kutya
7 | altes Haus | öreg ház
8 | feine Suppe | finom leves (fein - finom)
9 | teueres Kleid | drága ruha
10 | billige Hose | olcsó nadrágot
11 | rote Rosen | vörös rózsák (e Rose-n - rózsa)
12 | blauer Stuhl | kék szék
13 | faule Kinder | lusta gyerekek (faul - lusta)
14 | dummer Politiker | buta politikus (dumm - buta)
...
22 | fünf lichte Hosen | öt világos nadrágot (licht - világos)
23 | viele gute Kleider | sok jó ruha
24 | einige kleine Kuli | néhány kis tollat
25 | drei interessante Tage | három érdekes napot
26 | zwei dicke Katzen | két kövér macskát (dick - kövér)
27 | weige grünen Hasen | kevés zöld nyulat (r Hase - nyul)
...
36 | neues Jahr | új év
37 | guten Appetit | jó étvágyat (r Appetit - étvágy)
...
43 | einige mange Männer | néhány kövér férfi 
44 | lautem, kleinem, nervösem Hund | hangos, kicsi, ideges kutyának (nervös - ideges)
45 | billige, gute Ware | olcsó, jó áruk
46 | ldie Seiten guter Bücher | jó könyvek oldalali
47 | ldie Fenster hoher, großer Häuser | magas, nagy házak ablakai
48 | lschnellen, mageren Hunden | gyors, sovány kutyáknak
49 | lviele interessante Geschichten | sok érdekes történet
50 | lniedrige Kinder hoher Eltern | magas szülők alacsony gyermekei
\end{exmp}
...
G | des guten Vater | der guten Mutter | des guten Kindes | der guten Kinder
...
5 | den kleinen Wagen | a kicsi kocsi
...
11 | das dünne Mädchen | a vékony lány (dünn - vékony)
...
16 | das Kind des guten Vater | a jó apa gyereke
...
20 | die Beine der langsamen Hunde | a lassú kutyák lábai (das Bein - láb)
21 | der Arm des dünnen Kind | a vékony gyerek karja
...
25 | diese gelbe Jacke | ezt a sérga dzsekit (e Jacke - dzseki)
...
33 | jener interessante Mensch | az az érdekes ember (r Mensch - ember)
34 | alle interresanten Leuten | minden érdekes embert
35 | solches große Haus | olyan érdekes házat
...
40 | den netten, jungen Mädchen | kedves, fiatal lányoknak
41 | dem lauten hochen Lernen | a hangos, magas tanárnak
42 | das ruhige, stille Hund | a nyugodt, csöndes kutyát (ruhig - nyugodt, still - csöndes)
\end{exmp}
...
12 | Man spricht bei Essen nicht. | Étkezés közben (étkezésnél) nem beszélünk.
13 | Man darf hier nicht Fußball spielen. | Itt nem szabad focizni.
14 | Man isst in Ungarn viel Fleisch. | Magyarországon sok húst esznek.
15 | Man kann ohne Wasser nicht leben. | Víz nélkül nem lehet élni.
16 | Man darf dorthin nicht treten. | Oda nem szabad lépni.
17 | Was kann Man hier tut? | Mit lehet itt tenni?
