...
%Maklári: 243. oldal
\begin{exmp}
1 | Ich habe ihn in einer Restaurant essen sehen. | Láttam őt enni egy étteremben.
2 | Wer habt dich schreiben lehren? | Ki tanított téged írni?
3 | Sie hat gestern nicht gehen wollen. | Nem akart jönni (n) tegnap.
...
10 | Wir akarunk ihm in der Mathematik helfen wollen. | Akartunk segiteni neki (f) a matematikában. (e Mathematik)
...
14 | Wann habt ihr in das Kino gehen wollen? | Mikor akaratok moziba menni?
15 | Wo haben ihr kennen lernen? | Hol ismerkedtetek meg? (kennen lernen)
...
10 | Ich gehe vor ihrem Haus weg, ohne dass sie mich bemerkt. | Elmegyek a házuk előtt anélkül, hogy észrevenne (n) engem. (weggehen, bemerken)
...
%Maklári: 179. oldal
\begin{exmp}
1 | Wir geben für jede Frau Blume. | Minden nőnek adunk virágot.
...
8 | Es gibt in jeder Wohnung ein Badzimmer. | Minden lakásban van egy fürdőszoba. (es gibt)
9 | Jedes Buch kostet fünf Euro. | Minden könyv öt euróba kerül. (kostet + A, r Euro)
10 | Vater repariert heute jeden Tisch. | Apa holnap minden aszalt megjavít.
