...
6 | Ich merke mir all. | Én mindent megjegyzek.
7 | Merkt ihr euch die Regel? | Megjegyzitek a szabályt?
...
13 | Hört ihr euch das Konzer an? | Meghallgatjátok a koncertet?
...
19 | Hören wir uns diese Musik? | Meghallgatjuk ezt a zenét?
...
3 | Ich gehe sowohl in den Stadt, als auch sehe ich mir das Museum an. | A városba is megyek és a múzeumot is megnézem. (sich ansehen)
4 | Ich gebe dir sowohl Mittagessen, als auch wasche ich deine Haare. | Adok neked ebédet is és meg is mosom a hajadat.
5 | Sie gibt mir sowohl Schokolade, als auch nimmt sie mich in den Zoo. | Ad (n) nekem csokit is és el is visz az állatkertbez. (nehmen, r Zoo)
6 | Ich kaufe sowohl ein, als auch mache ich Ordnung in meinem Zimmer. | Be is vásároltam és rendet is tettem a szobámban.
...
9 | Er hat sowohl meine Suppe gegessen, als auch hat er die Vase zerstört. | A levesemet is megette (f) és a vázát is összetörte.
10 | Sie hat sowohl gespült, als auch hat sie eingekauft. | El is mosogatott (n) és be is vásárolt. (spülen (Perfekt))
11 | Wir haben heute sowohl Tennis gespielt, als auch haben wir uns die Bilder des Museums angesehen. | Ma teniszeztünk is és meg is néztük a múzeum képeit. (Tennis spielen (Perfekt), ansehen)
...
%Maklári: 370. oldal
\begin{exmp}
1 | Er sieht weder fern, noch liest sie Buch. | Se tévét nem néz (f), se könyvet nem olvas. (fernsehen)
2 | Er räumt weder in seinem Zimmer, noch spült er. | Se nem takarít (f) a szobájában, se nem mosogat. (spülen)
3 | Sie hilft weder mir, noch ist sie höflich zu mir. |  Se nem segít (f) nekem, se nem udvarias velem. (höflich sein zu + D)
4 | Ich bitte weder um Rat, noch hilfe ich dir. | Sem tanácsot nem kérek tőled, sem nem segítek neked. (um Rat bitten)
...
6 | Du lernt weder, noch leerst du den Mülleimer aus. | Se nem tanulsz, se nem viszed ki a szemeted. (den Mülleinmer ausleeren)
7 | Dieser Tier fliegen weder, noch schwimmt er. | Ez az állat se nem repül, se nem úszik.
8 | Er trinkt weder Alkohol, noch tanzt er mit den Mädchen. | Alkoholt sem iszik (f) és a lányokkal sem táncol.
...
12 | Es gibt auf diesen Planet weder Huhn, noch jagt Jäger. | Ezen a bolygón tyúk sincsen és vadász sem vadászik. (s Huhn, jagen)
\end{exmp}
